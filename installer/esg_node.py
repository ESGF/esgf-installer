...
def setup_temp_ca():
    ...
    if devel:
        urllib.urlretrieve("{esg_dist_url_root}/devel/esgf-installer/CA.pl".format(esg_dist_url_root = config.config_dictionary["esg_dist_url_root"]), "CA.pl")
        urllib.urlretrieve("{esg_dist_url_root}/devel/esgf-installer/openssl.cnf".format(esg_dist_url_root = config.config_dictionary["esg_dist_url_root"]), "openssl.cnf")
        urllib.urlretrieve("{esg_dist_url_root}/devel/esgf-installer/myproxy-server.config".format(esg_dist_url_root = config.config_dictionary["esg_dist_url_root"]), "myproxy-server.config")
    else:
        urllib.urlretrieve("{esg_dist_url_root}/esgf-installer/CA.pl".format(esg_dist_url_root = config.config_dictionary["esg_dist_url_root"]), "CA.pl")
        urllib.urlretrieve("{esg_dist_url_root}/esgf-installer/openssl.cnf".format(esg_dist_url_root = config.config_dictionary["esg_dist_url_root"]), "openssl.cnf")
        urllib.urlretrieve("{esg_dist_url_root}/esgf-installer/myproxy-server.config".format(esg_dist_url_root = config.config_dictionary["esg_dist_url_root"]), "myproxy-server.config")
