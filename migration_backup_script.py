...
def backup_esg_installation():
    ...
    directories_to_backup = ["/usr/local/tomcat", "/usr/local/solr", "/etc/grid-security", "/esg/content/thredds/catalog.xml", "/esg/config", "/usr/local/cog_config", "/etc/esgfcerts", "/etc/certs"]
